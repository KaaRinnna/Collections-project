...
export default function Hero() {
    return (
        <div className="relative isolate overflow-hidden bg-cyan-800 dark:bg-slate-950 py-24 max-md:py-10 h-[50vh] max-md:h-[85vh]">
                ...
                <div className="mx-auto grid grid-cols-1 gap-x-4 gap-y-16 lg:max-w-none md:grid-cols-2">
                    ...
                    <div
                        ...
                        <div className="flex flex-col items-start content-center justify-center py-2.5">
                            ...
                            <p className="text-gray-300 pt-2.5 mb-0 max-md:text-[1rem]">Add various items to your collections.</p>
                            <p className="text-gray-300 max-md:text-[1rem]">Edit, delete, add, inspect.</p>
                    ...
                    <div
                        ...
                        <div className="flex flex-col items-center max-md:items-start content-center justify-center py-2.5 mx-1.5">
                            ...
                            <p className="text-gray-300 max-md:text-[1rem]">...and anything you like!</p>
                            <p className="text-gray-300 text-center max-md:text-start max-md:text-[1rem]">Browse other authors` collections. Comment and like items!</p>
                        </div>
                    </div>

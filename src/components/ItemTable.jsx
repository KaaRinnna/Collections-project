...
export default function ItemTable() {
    ...
    return (
        loading ? <div className="absolute top-[50%] left-[50%] transform"><Spinner label="Loading..."/></div> :
            <div className="max-w-[1200px] mx-auto my-24 py-10 px-5 dark:bg-gray-900 rounded-large shadow-small dark:shadow-none">
                        ...
                        if (collectionDoc[stateKey] === true) {
                            return (
                                checkboxKey ? checkboxKey === true ? (
                                    ...
                                    (dateKey ? <div className="py-6 sm:grid sm:grid-cols-2 sm:gap-4 sm:px-0" key={key}>
                                            <dt className="dark:text-gray-200 font-normal">{collectionDoc[key]}</dt>
